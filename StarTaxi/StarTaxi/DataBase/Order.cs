namespace StarTaxi.DataBase
{
   internal class Order
   {
      ...
      public Order(int id, string id_client, string id_driver, string date, string price, double start_latitude, double start_longitude, double end_latitude, double end_logitude, string grade, string status, string tarif)
      {
         this.id = id;
