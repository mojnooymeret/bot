namespace StarTaxi.DataBase
{
   internal class Driver
   {
      ...
      public Driver(string id, string fio, string photo_face, string phone, string experiense, string auto, string plate_number, string photo_auto, string rating, string ride_count, string bank_card, string status)
      {
         this.id = id;
         this.fio = fio;
